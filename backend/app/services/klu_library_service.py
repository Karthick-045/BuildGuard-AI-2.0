...
audit findings, and vector blueprint SVG from the visual survey JSON.
"""
...
def import_klu_library_into_db(db: Session) -> Dict[str, Any]:
    """
    Ingests KLU Central Library data into SQLite/MySQL.
    """
    # 0. Clean up existing if present for a clean, deterministic refresh
    ...
    edges_data = [
        ...
        # Direct Room to Corridor edges matching JSON
        ("R1", "C1", "CONNECTS_TO"),
        ("R2", "C1", "CONNECTS_TO"),
        ("R3", "C1", "CONNECTS_TO"),
        ("R4", "C1", "CONNECTS_TO"),
    ...
    # 5. Insert BuildingSensors (corridors, rooms, stairs, doors)
    sensors_data = [
        # Corridors
        {"sensor_id": "S-C1-SMOKE", "type": "SMOKE", "element": "Main Corridor", "location": "C1 Main Ceiling", "value": 12.0, "unit": "ppm", "threshold": 50.0},
        {"sensor_id": "S-C1-TEMP", "type": "TEMPERATURE", "element": "Main Corridor", "location": "C1 Corridor Core", "value": 27.0, "unit": "°C", "threshold": 45.0},
        {"sensor_id": "S-C1-CO2", "type": "CO2", "element": "Main Corridor", "location": "C1 Central Circulation", "value": 415.0, "unit": "ppm", "threshold": 1000.0},
        # Staircase
        {"sensor_id": "S-S1-SMOKE", "type": "SMOKE", "element": "Main Staircase", "location": "S1 Stair Core Shaft", "value": 10.0, "unit": "ppm", "threshold": 50.0},
        {"sensor_id": "S-S1-TEMP", "type": "TEMPERATURE", "element": "Main Staircase", "location": "S1 Landing Head", "value": 27.0, "unit": "°C", "threshold": 45.0},
        # Rooms
        {"sensor_id": "S-R1-SMOKE", "type": "SMOKE", "element": "E-Library", "location": "R1 Digital Workstations", "value": 11.0, "unit": "ppm", "threshold": 50.0},
        {"sensor_id": "S-R1-TEMP", "type": "TEMPERATURE", "element": "E-Library", "location": "R1 Study Area", "value": 23.5, "unit": "°C", "threshold": 45.0},
        {"sensor_id": "S-R2-SMOKE", "type": "SMOKE", "element": "Media Resource Centre", "location": "R2 AV Media Console", "value": 12.5, "unit": "ppm", "threshold": 50.0},
        {"sensor_id": "S-R2-CO2", "type": "CO2", "element": "Media Resource Centre", "location": "R2 Conference Hub", "value": 430.0, "unit": "ppm", "threshold": 1000.0},
        {"sensor_id": "S-R3-TEMP", "type": "TEMPERATURE", "element": "Ladies Toilet", "location": "R3 Restroom Duct", "value": 26.0, "unit": "°C", "threshold": 45.0},
        {"sensor_id": "S-R4-TEMP", "type": "TEMPERATURE", "element": "Gents Toilet", "location": "R4 Restroom Duct", "value": 26.0, "unit": "°C", "threshold": 45.0},
        {"sensor_id": "S-R5-SMOKE", "type": "SMOKE", "element": "Book Bank Section", "location": "R5 Book Stack Aisle", "value": 14.0, "unit": "ppm", "threshold": 50.0},
        {"sensor_id": "S-R6-SMOKE", "type": "SMOKE", "element": "Back Volume / Project Report Section", "location": "R6 Archives Stacks", "value": 13.5, "unit": "ppm", "threshold": 50.0},
        # Doors
    ...
    return {
        ...
        "message": "KLU Central Library successfully synthesized with CAD blueprint, safety graph, and IoT sensor mesh."
    }
